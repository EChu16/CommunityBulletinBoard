...
new_comment_payload = {"comment_text" : "i like toitles too", "post_id" : "58fd3094c1336721fb5b82a9"}
...
if r1.status_code == 200:
	...
	r2 = r.post(base_url + 'comments/new', verify=False, cookies=r1.cookies, json=new_comment_payload)
	print r2.content
